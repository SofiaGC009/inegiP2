...
public class MaterialVivienda extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Material Viviendas");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                ...
                {"6", "Piedra"},
                {"7", "Prefabricada"},
                {"8", "Material Ecologico"},
                {"9", "Paja, ramas o caña"},
                {"10", "Adobe Moderno"}
            },
            new String [] {
                "idMaterial", "Tipo de Material"
            }
        ));
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MaterialVivienda().setVisible(true);
            }
        });
    }
